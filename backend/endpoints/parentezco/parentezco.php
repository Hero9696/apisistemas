...
Endpoint para gestionar Parentezcos
=============================================*/
...
Sistema de validación y gestión de Parentezcos
=============================================*/
...
// Campos obligatorios para Parentezco
$camposObligatorios = [
    'DesParentezco',
    'FechaCreacion',
    'UsuarioCreacion',
...
switch ($method) {
    ...
    case 'POST':
        ...
        PostController::postData('Parentezco', $data);
        break;

    case 'PUT':
        $data = json_decode(file_get_contents('php://input'), true);
        $id = $_GET['id'] ?? null;
        $nameId = 'id_Parentezco';
        ...
        PutController::putData('Parentezco', $data, $id, $nameId);
        break;
    ...
    case 'DELETE':
        ...
        DeleteController::deleteData('Parentezco', $id, $nameId);
        break;
