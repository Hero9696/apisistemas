...
// Llama al controlador para registrar los datos en la tabla 'TerapeutaEspe'  // Cambiado de 'Terapeuta' a 'TerapeutaEspe'
PostController::postData("TerapeutaEspe", $input);
